...
namespace RestApp.Web.Controllers
{
    ...
    public class UserController : BaseApController
    {
        ...
        public ActionResult List(string q)
        {
            ...
            foreach (var user in gUserService.GetFilteredUsers(q))
            {
                listModel.Add(PrepareUserModelForList(user));
            }
            ...
            ViewBag.Letters = gUserService.GetFirstLetterFilter();
        ...
        public ActionResult Create(NewUserModel model, FormCollection formData)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(gLocalizationService.GetResource("Controller.Success.User.Insert"));
        ...
        public ActionResult Delete(int id)
        {
            ...
            SuccessNotification(gLocalizationService.GetResource("Controller.Success.User.Delete"));
        ...
        [NonAction]
        protected ListUserModel PrepareUserModelForList(User user)
        {
