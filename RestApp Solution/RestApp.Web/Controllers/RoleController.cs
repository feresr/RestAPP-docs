...
namespace RestApp.Web.Controllers
{
    ...
    public class RoleController : BaseApController
    {
        ...
        public ActionResult ExportToExcel(string q)
        {
            ...
            data.Columns.Add(gLocalizationService.GetResource("View.Role.Name"), Type.GetType("System.String"));

            // Get the data
            foreach (var localeString in gRoleService.GetFilteredRoles(q))
            {
